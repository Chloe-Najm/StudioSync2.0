...
export function StudioChatbot() {
  ...
  const [messages, setMessages] = useState([
    {
      role: "assistant",
      content: "Hi there! I'm your StudioSync AI assistant. How can I help you manage your fitness studio today?",
    },
  ])
  ...
  const handleSend = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/chat/studio`, {
        method: "POST",
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="text-3xl font-bold tracking-tight text-[#333333]">Studio AI Assistant</h1>
        <p className="text-[#666666] mt-1">Ask questions about managing your fitness studio.</p>
      </div>
